...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two str as arguments
     *
     * @param fname a string which is the first name
     * @param lname a string which is the last name
     * */
    public Silly(String fname, String lname){this.name = fname + lname;}
